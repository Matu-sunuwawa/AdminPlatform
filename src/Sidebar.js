    ...
    <div className={`sidebar ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      <ul className="sidebar-menu">
        <li className="menu-item">
          <NavLink to="/home" className={({ isActive }) => (isActive ? 'active' : '')} onClick={() => setIsOpen(false)}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="menu-item">
          <NavLink to="/disputes" className={({ isActive }) => (isActive ? 'active' : '')} onClick={() => setIsOpen(false)}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="menu-item">
          <NavLink to="/transactions" className={({ isActive }) => (isActive ? 'active' : '')} onClick={() => setIsOpen(false)}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
